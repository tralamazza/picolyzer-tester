...
1. Download `picolyzer-tester-v0.5.1.uf2` from the
...
```
picolyzer-tester 0.5.1 - logic analyzer stimulus generator
`help` for commands
> id
ok fw=picolyzer-tester/0.5.1 sysclk=150000000 channels=16 tick_ps=6666 max_samples=4096 xtal_ppm=30
> glitch 0 1
